...
// ------------------ CHECK ENV ------------------
console.log("Loaded DB:", process.env.MONGODB_URI);
...
const createStudent = (i) => {
  ...
  const allSubs = academic.flatMap((s) => s.subjects);
  ...
  return {
    ...
    uid: uuidv4(),
    nfcUID: uuidv4(),
    verifyURL: `https://yourdomain.com/verify/${uuidv4()}`,
  };
};
...
const seedData = async () => {
  try {
    console.log("Clearing old students...");
